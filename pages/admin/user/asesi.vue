<template>
  <div>
    <div class="content-header">
      ...
      <tw-breadcrumb :items="[{ text: 'Home', route: 'admin' },{ text: 'User' },{ text: 'Asesi' }]" />
    </div>
    <div class="shadow-xl">
...
import { useOurCrudSchedule, url } from '@/api/admin/accession.js'
export default {
  setup (props, { root, refs }) {
    ...
    const {
      ...
      modalDelete,
      modalBulkDelete
    } = useOurTableActionModal(root, refs, 'asesi', { create, update, destroy }, initInput)
  ...
  head: {
    title: 'Dashboard - Admin - User - Asesi'
  }
}
